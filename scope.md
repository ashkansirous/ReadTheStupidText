...
- A **persistent/dockable** settings window with tabs, taskbar presence, or hotkey-remap UI. The control panel is transient and light-dismiss; every control maps to an existing service rather than introducing new settings.
