...
public sealed partial class MainWindow : Window
{
    ...
    public MainWindow(ReadAloudService readAloud, IHotkeyService hotkey, IClipboardMonitor clipboardMonitor, IStartupService startup, IActivityLog activityLog)
    {
        ...
        _toggleAutoReadSelectionCommand = new RelayCommand(_ => _readAloud.AutoReadOnSelection = !_readAloud.AutoReadOnSelection);
        _toggleAutoReadCopyCommand = new RelayCommand(_ => _readAloud.AutoReadOnCopy = !_readAloud.AutoReadOnCopy);
    ...
    // The toggles can be flipped from the control panel too; mirror the checkmark
